...
// ============================================================================
// MANUAL VENDOR — derived from JetBrains/compose-multiplatform-core navigation3/
//   navigation3-ui/.../scene/BackStackAwareLifecycleNavEntryDecorator.kt (ref:
//   tools/compose-fork/compose-ref.txt). NON-IDEMPOTENT — excluded from the folder
//   sync via a `!` line in compose-fork.txt; reconcile by hand on ref bumps.
// CHANGE vs upstream: `rememberLifecycleOwner(maxLifecycle=…)` → `LocalLifecycleOwner.current`.
//   rememberLifecycleOwner spins on Kotlin/Native (see NavDisplay.kt header). Entries stay
//   RESUMED instead of being capped at CREATED once off the back stack — acceptable here.
// ============================================================================
