...
//   navigation3-ui/.../scene/DialogScene.kt (ref: tools/compose-fork/compose-ref.txt).
//   NON-IDEMPOTENT — excluded from the folder sync via a `!` line in compose-fork.txt.
// CHANGE vs upstream: `rememberLifecycleOwner()` → `LocalLifecycleOwner.current`.
//   rememberLifecycleOwner spins on Kotlin/Native (see NavDisplay.kt header).
// ============================================================================
...
internal class DialogScene<T : Any>(
    ...
    override val content: @Composable (() -> Unit) = {
        val lifecycleOwner = LocalLifecycleOwner.current  // MANUAL VENDOR: see header (K/N rememberLifecycleOwner spin)
