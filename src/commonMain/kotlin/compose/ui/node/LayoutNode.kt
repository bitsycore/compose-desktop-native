...
class LayoutNode {
    ...
    // ============
    //  Computed absolute position (for hit testing / drawing)
    ...
    // Applies SizeModifier adjustments
    ...
    fun hitTest(px: Int, py: Int): LayoutNode? {
        ...
        // Children drawn later are on top → check in reverse
