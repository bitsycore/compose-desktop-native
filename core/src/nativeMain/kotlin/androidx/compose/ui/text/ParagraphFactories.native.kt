...
/* Carries text+style for the intrinsics-based Paragraph factories; intrinsic widths come from a
   throwaway unbounded SdlParagraph. */
internal class SdlParagraphIntrinsics(
	val paragraphText: String,
	val paragraphStyle: TextStyle,
) : ParagraphIntrinsics {
	private val probe = SdlParagraph(paragraphText, paragraphStyle, Float.POSITIVE_INFINITY, Int.MAX_VALUE)
...
): ParagraphIntrinsics = SdlParagraphIntrinsics(text, style)
...
actual fun Paragraph(
	...
	density: Density,
	resourceLoader: Font.ResourceLoader,
): Paragraph = SdlParagraph(text, style, width, maxLines)
...
actual fun Paragraph(
	...
	maxLines: Int,
	ellipsis: Boolean,
): Paragraph = SdlParagraph(text, style, widthFrom(constraints), maxLines)
...
actual fun Paragraph(
	...
	return SdlParagraph(vI.paragraphText, vI.paragraphStyle, width, maxLines)
}
...
actual fun Paragraph(
	...
	val vI = paragraphIntrinsics as SdlParagraphIntrinsics
	return SdlParagraph(vI.paragraphText, vI.paragraphStyle, widthFrom(constraints), maxLines)
}
