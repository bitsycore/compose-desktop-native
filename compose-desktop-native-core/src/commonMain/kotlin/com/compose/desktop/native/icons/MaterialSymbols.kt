...
/* Curated subset of Google's Material Symbols codepoints. Style-specific
   font modules (compose-desktop-native-material-symbols-{outlined,rounded,
   sharp}) ship the glyphs and register a font family with IconFont. The
   codepoint values are identical across the three styles, so they live in
   core and any installed style renders them.
