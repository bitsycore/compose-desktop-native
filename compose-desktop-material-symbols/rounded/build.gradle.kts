// compose-desktop-material-symbols:rounded — Rounded style of Material
// Symbols. Mirrors the :outlined module but ships a different .ttf and
// registers under a different family name. See the :outlined module for
// architectural notes.
