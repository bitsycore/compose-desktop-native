// compose-desktop-material-symbols:sharp — Sharp style of Material Symbols.
// Mirrors the :outlined module but ships a different .ttf and registers
// under a different family name. See :outlined for architectural notes.
