...
/* Public factory the compose-desktop-native module calls (its per-target
   makeRenderBackend actual delegates here when Skia is the selected renderer).
   Mirrors the SDL3 module's createRenderBackend / rendererPreferredGpuMode in
   the same package; exactly one renderer module is included per target. Rejects
